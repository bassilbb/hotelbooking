                ...
                <div class="col-lg-12">
                    <div class="contact-title">
                        <div class="section-title">
                            ...
                            <h2>Located in the center of <br />Lagos</h2>
                        </div>
                        <a href="http://www.maplandia.com/nigeria/lagos/lagosisland/lagos/" class="primary-btn">Get Directions</a>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="info-box">
                        ...
                        <ul>
                            <li>27 Madison Lane, <br />Lagos</li>
                            <li> (234)813-464-5652</li>
                            <li>bassiluv13@gmail.com</li>
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="footer-item">
                        <h5>Contact Info</h5>
                        <ul>
                            <li><img src="img/placeholder.png" alt="">1525 Boring Lane,<br />Lagos</li>
                            <li><img src="img/phone.png" alt=""> (234)813-464-5652</li>
                        </ul>
                    </div>
                </div>
            </div>
