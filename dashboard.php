...
<head>
    ...
    <title>Bassi Hotel & Luxury </title>
    ...
    <header class="header-section">
        <div class="container-fluid">
            <div class="inner-header">
                ...
                <div class="nav-right">
                    <a href="bookroom.php" class="primary-btn">Make a Reservation</a>
                </div>
                ...
                <div class="col-lg-6">
                    <div class="about-text">
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus libero mauris, bibendum eget
                            ...
                            malesuada. </p>
                        <a href="bookroom.html" class="primary-btn">Make a Reservation</a>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="footer-item">
                        <h5>Contact Info</h5>
                        <ul>
                            <li><img src="img/placeholder.png" alt="">15 Wale Street Lagos,<br />Ikoyi Lasgidi</li>
                            <li><img src="img/phone.png" alt="">+1 (+234)813-464-5652</li>
                        </ul>
                    </div>
                </div>
            </div>
