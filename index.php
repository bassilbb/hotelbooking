...
<head>
    ...
    <title>Bassi Hotel & Luxury | Template</title>
...
<body>
            ...
            <div class="row intro-text">
                ...
                <div class="col-lg-6">
                    <div class="intro-right">
                        ...
                        <a href="login.html" class="primary-btn">Make a Reservation</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- <div class="video-section">
        <div class="video-bg set-bg" data-setbg="images/HotelVideo.jpg.mp4"></div>
        <div class="container">
            <div class="video-text set-bg" data-setbg="images/HotelVideo.jpg.mp4">
                <a href="https://www.youtube.com/watch?v=j56YlCXuPFU" class="vvv"><i class="fa fa-play"></i></a>
            </div> -->

            <div  class="video-section" >
                <div style="text-align:center;">
                    <iframe width="500" height="600" class="video" 
                     src="images/CinematicHotels.mp4" type="video/mp4"> 
                        <source src="images/Video.mp4" type="video/mp4">
                </iframe>
                      </div>
                <!-- <video  width="400" height="500" controls="controls"> -->
                    <!-- <source src="images/CinematicHotels.mp4" type="video/mp4"> -->
                    <!-- <source src="images/Video.mp4" type="video/mp4"> -->
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="footer-item">
                        <h5>Contact Info</h5>
                        <ul>
                            <li><img src="img/placeholder.png" alt="">N0:15 Fatai Ajayi Street,<br />Isheri Oshun Lagos </li>
                            <li><img src="img/phone.png" alt=""> (+234)535-4592</li>
                        </ul>
                    </div>
                </div>
            </div>
